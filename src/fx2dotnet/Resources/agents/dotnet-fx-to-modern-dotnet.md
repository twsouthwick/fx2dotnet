...
Before any modernization actions, verify assessment.md exists:
- Determine expected path:
   - If assessmentPath input provided, use it
...
- Ask user for a valid assessment.md path generated by the Visual Studio AppMod tool
- Explain that orchestration cannot continue until this prerequisite is provided
- Stop

If assessment.md exists, validate basic provenance:
- Read file and look for AppMod-style indicators (for example references to assessment, analysis, inventory, modernization assessment, or Visual Studio output)
